...
$sql = "SELECT * 
        ...
        WHERE guru.guru_id = '$_GET[key]'";
$result = mysqli_query($conn, $sql);

$sql2 = "SELECT nama FROM guru WHERE guru_id = '$_GET[key]'";
...
<section id="app" class="section">
    <div class="card bg-transparent">
        <div class="card-header bg-transparent flex">
            <a href="informasi-jadwalguru.php" class="btn p-0 icon icon-left"> <i class="bi bi-arrow-return-left"></i>
                Kembali</a>
            <h4 class="card-title container">Informasi Atas Nama <?php echo $data2['nama'];?></h4>
        </div>
    </div>
